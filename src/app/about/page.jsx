...
export default function About() {
    return (
        <div className="container mx-auto max-w-3xl px-4 py-12 min-h-screen flex">
            <div className="rounded-lg shadow-lg p-6 border border-gray-500">
                <h1 className="text-xl sm:text-3xl font-semibold mb-6 text-center">Sobre o Projeto</h1>
